    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <li class="nav-item dropdown" data-toggle="tooltip" data-placement="bottom" title="Notification" style="margin-right:13px;">
          ...
          <div class="dropdown-menu dropdown-menu_count" aria-labelledby="alertsDropdown">
            ...
            <a  href="view_message_content_all_users.php" class="dropdown-item">
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
       ...
       <div class="card-body">
               ...
               <?php  
                 $connect = mysqli_connect("localhost", "root", "", "villa_dblgu");  
                $query = "SELECT * FROM users  WHERE Fullname != '".$_SESSION["Fullname"]."'  ORDER BY id ";  
                 $result = mysqli_query($connect, $query);  
                 ?> 
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                 <?php  
                               ...
                               ?>  
                               <tr> 
                                    <td><img src='../Phplogin/adding_updating_user/uploads/<?php echo $row["file"]; ?>' width="50" hieght="30" class="img-circle"></td>   <td><?php echo $row["Fullname"]; ?>
                                  </td>
                                    <td><?php echo $row["position"]; ?></td> 
                                        <td><?php echo $row["office"]; ?></td> 
                                    <td><input data-toggle="tooltip" data-placement="top" title="View user information" type="button" name="edit" style="background:#09568d;color:white;font-size:11px;padding:4px 5px 4px 4px;" value="View" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view" /> 
                                      <button type="button" data-toggle="tooltip" data-placement="top" title="Update user information" name="edit"  style="color:white;font-size:11px;padding:5px 5px 5px 5px;" id="<?php echo $row["id"]; ?>" class="btn btn-success btn-xs edit_user_data" /> <span class="fa fa-edit"> </span>  </button>
                                       <button type="button" data-toggle="tooltip" data-placement="top" title="Delete user" name="edit" style="color:white;font-size:11px;padding:5px 5px 5px 5px;" id="<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs view_delete" /> <span class="fa fa-trash"> </span>  </button>
...
?>" type="hidden"  name="Date_created"  class=" form-control" style="height:40px;font-size:15px;width:400px;background:#424d57;color:white;" >
                        ...
                        <span style="color:black;">Forward To:</span> 
                          ...
                          <input type="hidden" value="view_all_users" name="refresh_page">
           ...
           <div class="modal-content">  
            ...
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true">×</span>
                ...
                <div class="modal-body table-responsive" style="height:450px;"> 

                    <?php include('update_user.php') ?>
                                   

                     <form method="post" action="view_all_users.php" enctype="multipart/form-data">  
                      <div class="form-group">  
                               <span  style="margin-left:0;"> <strong> User_profile: </strong></span>
                                  <input type="file"  class="form-control" name="file" style="color:black;margin-right:5px;"  id="upload" />

                              </div>

                          <div class="form-group">  
                         <!-- id ni -->
                          <input class="form-control" type="hidden" style="height:40px;color:  black;border:1px solid"  name="id" id="id" />  
                       </div> 

                     <div <?php if (isset($fullname_error)): ?> class="form_error" <?php endif ?> class="form-group" > 
                         <!-- first_name ni -->
                        <span><strong> Name: </strong></span>
                          <input class="form-control" type="text" style="height:40px;color:  black;border:1px solid"  name="Fullname" id="Fullname" />  
                       </div>
                        ...
                        <span><strong> Username: </strong></span>
                          <input class="form-control" type="text" style="height:40px;color:  black;border:1px solid" name="username" id="username" />  
                       </div>  
                        ...
                        <span><strong>Email: </strong></span>
                          <input class="form-control" type="text" style="height:40px;color:  black;border:1px solid"  name="email" id="email" />  
                       </div>   
                        <div class="form-group">  
                         <!-- id ni -->
                        <span><strong> Position: </strong></span>
                          <input class="form-control" type="text" style="height:40px;color:  black;border:1px solid"  name="position" id="position" />  
                       </div> 
                        <div class="form-group">  
                         <!-- id ni -->

                        <span><strong> Office: </strong></span>
                          <input class="form-control" type="text" style="height:40px;color:  black;border:1px solid;"  name="office" id="office" />  
                       </div> 
                        <span><strong>Password:</strong></span>
                           <div  <?php if (isset($password_error)): ?> class="form_error" <?php endif ?> class="form-group" >

                                <input type="password" class="form-control" maxlength="8" minlength="5" name="password"  style="height:40px;color:  black;border:1px solid" id="txtPassword" value="<?php echo $password; ?>"  class="form-control" >
                             ...
                             <?php endif ?>
                              ...
                              <div class="form-group">
                                <input type="password" class="form-control" maxlength="8"  style="height:40px;color:  black;border:1px solid" minlength="5"  id="txtConfirmPassword" value="<?php echo $password; ?>"  class="form-control" >
                ...
                <div class="modal-footer" style="background:#d9d9d9;"> 
                     ...
                     <button type="submit" id="GO" name="btn-update" class="btn btn-primary">Update Information</button>   
               ...
               <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default" style="width:540px;">
                        ...
                        <i class="fa fa-table" ></i> Admin's Office</div>
                        <!-- /.panel-heading -->
                     ...
                     <form method="post" id="insert_form" action="reply_message.php">  
                       <div class="form-group">  
                          ...
                          <input type="hidden" style="background:white;" name="id" id="reply_id" class="form-control" />
                            ...
                            <input type="hidden" style="background:white;" name="reply_refresh" value="view_all_users" class="form-control" />
                ...
                $query = "SELECT * FROM users WHERE Fullname = '".$_SESSION["Fullname"]."' ";  
                 ...
                 <?php  
                             ...
                             <input type="hidden" name="senders_office" value="Admin Office">
                              <input type="hidden" name="create_refresh" value="view_all_users">
                ...
                $query = "SELECT * FROM users WHERE Fullname = '".$_SESSION["Fullname"]."' ";  
                 ...
                 <?php  
                               ...
                               ?> 
                                ...
                                <input type="hidden" value="<?php echo $row["office"];?>">
                                <?php  
                               }  
                               ?> 
...
?>" class=" form-control" style="height:40px;font-size:15px;background:#424d57;color:white;">
                        ...
                        <input type="hidden" value="view_all_users" name="accept_refresh"/> 
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '.document_incoming', function(){  
           var employee_id = $(this).attr("id");  
           $.ajax({  
                url:"fetch_table.php",  
                method:"POST",  
